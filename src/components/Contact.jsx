...
const Contact = () => {
  return (
    <>
      <section className=" w-full mx-auto relative overflow-hidden bg-white py-20 dark:bg-dark lg:py-[120px]">
              ...
              <div className="mb-12 md:ml-8 lg:ml-8 max-w-[570px] lg:mb-0 sm:w-full">
                ...
                <div className="mb-8 flex w-full md:mx-0 lg:mx-0 sm:mx-28 max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      EVEREST FOOD STREET, THAIYUR MAIN ROAD, KELAMBAKKAM, OMR, CHENNAI-603103.
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-8 md:mx-0 lg:mx-0 sm:mx-28 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-darkgreen/5 text-primary sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <svg clipPath="url(#clip0_941_17577)">
                        <path
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                    <a href="tel:+">+91 8925351188</a> <br />
                    <a href="tel:+">+91 8925351199</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-8 md:mx-0 lg:mx-0 sm:mx-28 sm:mt-4 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      <a href="mailto:info@meitallian.in">info@meitallian.in</a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className=" relative rounded-lg bg-white p-6 shadow-lg dark:bg-dark-2">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-primary bg-darkgreen p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
