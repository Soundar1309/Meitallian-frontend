    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img className="w-auto h-24 md:mx-0 lg:mx-0 mx-auto" src="./logo.png" alt="" />

                <p className="text-base leading-relaxed text-gray-600 mt-7">Savor the artistry where every dish is a culinary masterpiece</p>
                ...
                <ul className="flex items-center space-x-3 mt-9">
                    ...
                    <li>
                        <a href="https://www.facebook.com/profile.php?id=61559395388886" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <li>
                        <a href="https://www.instagram.com/me_italian_/" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#/menu" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Menu </a>
                    </li>
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                    <li>
                        <a href="#/terms-condition" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Terms & Conditions </a>
                    </li>
            ...
            <div className="col-span-2 sm:col-auto md:col-span-1 lg:col-span-2 lg:pl-8">
                <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase">Subscribe to newsletter</p>

                <form action="#" method="POST" className="mt-6">
                    <div>
                        <label htmlFor="emailto:meitalian2024@gmail.com" className="sr-only">Email</label>
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by <span><a href="http://meitalian.in/">Meitalian</a></span> | Developed by Codefi Corporation</p>
    </div>
</section>
